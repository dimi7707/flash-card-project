    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Link
            href="/add-card"
            className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-primary-500"
          >
            ...
            <h2 className="text-2xl font-bold mb-3 text-gray-900">Add Cards</h2>
          ...
          >
            ...
            <h2 className="text-2xl font-bold mb-3 text-gray-900">Learn & Practice</h2>
            <p className="text-gray-600 mb-4">
          ...
          >
            ...
            <h2 className="text-2xl font-bold mb-3 text-gray-900">Take a Test</h2>
            <p className="text-gray-600 mb-4">
        ...
        <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-8 text-white text-center">
          <h3 className="text-3xl font-bold mb-4">Ready to expand your vocabulary?</h3>
